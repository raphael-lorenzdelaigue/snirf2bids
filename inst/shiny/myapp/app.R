                 ...
                 tabPanel("Select input and output folder - choose conversion routine",
                          ...
                          card(
                            ...
                            div(
                              ...
                              tags$code("output"),
                              "folder will be structured according to BIDS nomenclature at the end of the conversion process, if it is successful.",
                              br(),
                              "BIDS follows a specific filesystem structure, where data is placed in a separate subdirectory for each study participant. This subfolder is named ",
                              tags$code("sub-<label>"),
                              "where ",
                              tags$code("<label>"),
                              ...
                              tags$code("<label>"),
                              "is assigned to each measurement session. After succesful conversion, the NIRS recording data will be saved within each of these subfolders.",
                              br(),
                              "Besides the SNIRF file containing the recorded data, a range of metadata files will be created. These contain various informations such as a description of NIRS channels, task-related events or further technical aspects of the recording in the sidecar JSON. Only some of these files are strictly required to comply with BIDS specifications. Others are either recommended or optional.",
                              br(),
                              icon("book"),
                              " ",
                              tags$a(
